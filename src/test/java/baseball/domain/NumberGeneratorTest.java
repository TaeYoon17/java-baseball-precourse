...
public class NumberGeneratorTest {
	...
	void generateIntNumbers() {
		...
		// when
		List<Integer> generatedNumbers = numberGenerator.execute(now);
	...
	void generateFixedNumbers() {
		...
		// when
		List<Integer> result1 = numberGenerator.execute(fixedDate);
		List<Integer> result2 = numberGenerator.execute(fixedDate);
